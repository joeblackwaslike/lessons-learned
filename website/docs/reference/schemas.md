...
| `type`               | `string`                     | ✓        | `directive \| guard \| hint \| protocol \| reminder`      | Authoritative injection behavior                                                                                         |
...
| `outputPatterns`     | `string[]`                   | ✓        | Default: `[]`                                             | Regex matched against `tool_response` (stdout). Used with `reminder` type; compiled to `outputRegexSources` in manifest. |
...
| `type`                | `string`         | ✓        | `directive \| guard \| hint \| protocol \| reminder`                    |
...
| `outputRegexSources`  | `RegexSource[]`  | —        | Pre-compiled output-pattern sources matched against `tool_response`     |
