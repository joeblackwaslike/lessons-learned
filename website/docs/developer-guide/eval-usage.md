...
description: How to run, read, and act on eval results for lessons-learned using the promptfoo-based evaluation harness.
---
...
For guidelines on writing effective scenario prompts, seed workspaces, verify scripts, and diagnosing SKIP results, see [eval-scenario-writing.md](eval-scenario-writing.md).
