...
**Changes that affect injection** (injectionBudgetBytes, maxLessonsPerInjection, minConfidence, minPriority) — note: "This takes effect immediately. Run `node scripts/lessons.mjs build` to rebuild the manifest if you want to verify what's included."
